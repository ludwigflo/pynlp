...
def test_sub_module(sub_module_name: str) -> tuple:
    ...
    sub_module_function = getattr(utils, sub_module_name)
    ...
    for i, test_case in enumerate(test_cases):
        ...
        if out_come == expected_outcomes[i]:
...
def sub_modules_unit_tests():
    ...
    exclude_files = ['__init__.py', '__pycache__', 'dummy_parameters.yaml']
    ...
    print()
    print('================================================================================')
    print('Unit Tests of Module utils - Summary')
    print('--------------------------------------------')
